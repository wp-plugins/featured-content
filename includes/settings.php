...
<div class="wrap">
     <form method="post" action="options.php" id="featured_content_settings">
          ...
          <?php settings_fields($this->optionsName); ?>
               ...
               <?php endforeach; ?>
                         <li id="featured_content_save" class="featured-content save-tab">
                              <a href="#top" onclick="featured_content_settings_save()"><?php _e('Save Settings', 'featured-content'); ?></a>
                         </li>                    </ul>
               ...
               <?php require_once('sidebar-boxes.php'); ?>
                         </div>
                    </form>
